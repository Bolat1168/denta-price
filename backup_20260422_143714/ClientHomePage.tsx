...
export default function ClientHomePage() {
  ...
  // Множество для отслеживания уже зафиксированных просмотров (чтобы не дублировать)
          ...
          <div className="w-[65%] flex flex-col justify-between">
            <div>
              ...
              <div className="text-xs font-black mt-1">
                {formattedPrice !== '0' ? `${formattedPrice} ₸` : 'ТЕНГЕ / ОТ'}
              </div>
            </div>
          </div>
        </div>
                  ...
                  return (
                    <div key={`empty-${index}`} className="border border-gray-200 bg-white p-3">
                      <div className="flex gap-3">
                        ...
                        <div className="w-[65%]">
                          <h3 className="text-sm font-black uppercase text-gray-400">ФАМИЛИЯ И.О</h3>
                          <div className="text-xs text-gray-400 mt-1">УСЛУГА</div>
                          <div className="text-xs font-black mt-1 text-gray-400">ТЕНГЕ / ОТ</div>
                        </div>
                      </div>
                      <button className="w-full bg-green-600 text-white py-2 mt-3 cursor-not-allowed opacity-50" disabled>ЗАПИСАТЬСЯ</button>
                    </div>
                  );
                }
              })}
